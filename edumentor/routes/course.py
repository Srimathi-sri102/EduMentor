...
def generate_course():
    ...
    prompt = (
        ...
        f'{{"title": "Course Title", "description": "2-3 sentence course overview", '
        f'"skill": "{skill}", "level": "{level}", '
        f'"total_modules": {modules_count}, '
        f'"modules": ['
        f'{{"id": 1, "title": "Module Title", "description": "What this module covers", '
        f'"lessons": [{{"id": 1, "title": "Lesson Title", "duration": "15 min", "type": "theory"}}]'
        f'}}]}}'
...
def generate_lesson():
    ...
    prompt = (
        ...
        f'"content": "Detailed lesson content as plain text paragraphs separated by newlines. Explain concepts thoroughly.", '
        f'"code_examples": [{{"title": "Example name", "language": "python", "code": "actual working code", "explanation": "what this code does"}}], '
        f'"key_takeaways": ["takeaway 1", "takeaway 2"], '
        f'"exercises": [{{"question": "exercise description", "hint": "helpful hint", "solution": "solution code or explanation"}}], '
        f'"summary": "2-3 sentence lesson summary"'
        f'}}'
    )
    try:
        resp = client.chat.completions.create(
